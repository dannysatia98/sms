            ...
            <form class="user" method="post" action="<?= base_url('Kelas_CRUD/update'); ?>">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm mb-3 mb-sm-0 cek">
                  <input type="text" class="form-control" id="kelas_nama" name="kelas_nama" placeholder="Nama Kelas" value="<?= set_value('kelas_nama', $kelas_update['kelas_nama']) ?>">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm mb-3 mb-sm-0 cek">
                  <input type="text" class="form-control" id="kelas_nama_singkat" name="kelas_nama_singkat" placeholder="Singkatan (Ex: Xsc1)" value="<?= set_value('kelas_nama_singkat', $kelas_update['kelas_nama_singkat']) ?>">
